...
1. [Node/Nest.js](backend)
    ...
    1. Remove the `backend-python and backend-java` folder
    2. Remove the `backend-py, database-migrations-py and backend-java` from pr-open.yml in the builds section
    3. Remove the `backend-py and backend-java` from pr-open.yml in the deployments section
    4. Remove the `backend-py, database-migrations-py and backend-java` from pr-close.yml in the image-promotions section
    5. Remove the `backend-py, database-migrations-py and backend-java` from merge-main.yml in the deployments
    6. Remove the docker-compose.py.yml from the root of the repository
2. [Python/FastAPI](backend-python)
   To use this backend,  please remove the followings
    1. Remove the `backend and backend-java` folder
    2. Remove the `backend, database-migrations and backend-java` from pr-open.yml in the builds section
    3. Remove the `backend and backend-java` from pr-open.yml in the deployments section
    4. Remove the `backend, database-migrations and backend-java` from pr-close.yml in the image-promotions section
    5. Remove the `backend, database-migrations and backend-java` from merge-main.yml in the deployments
    6. Remove the docker-compose.yml from the root of the repository
3. [Java/Quarkus](backend-java)
   To use this backend,  please remove the followings
    1. Remove the `backend and backend-python` folder
    2. Remove the `backend, database-migrations , database-migrations-py and backend-python` from pr-open.yml in the builds section
    3. Remove the `backend and backend-python` from pr-open.yml in the deployments section
    4. Remove the `backend, database-migrations, database-migrations-py and backend-python` from pr-close.yml in the image-promotions section
    5. Remove the `backend, database-migrations, database-migrations-py and backend-python` from merge-main.yml in the deployments
    6. Remove the docker-compose.py.yml from the root of the repository
4. [Golang/Fiber](backend-go)
