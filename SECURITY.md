...
| **V14.2** | Secret Management | Separates database connection credentials, API keys, and environment-specific configs from code. | Configuration materialized via OpenShift Secrets templates in [common/openshift.secret.yml](file:///home/derek/Repos/quickstart-openshift/common/openshift.secret.yml). |
