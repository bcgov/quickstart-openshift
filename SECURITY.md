...
| **V14.2** | Local Secret Leak Prevention | Prevents accidental commits of staged secrets, API keys, and tokens during local development. | Recommended client-side [Gitleaks](https://github.com/gitleaks/gitleaks) pre-commit hooks via [bcgov/agent-guardrails](https://github.com/bcgov/agent-guardrails). |
